...
import { Directive, TemplateRef, ViewContainerRef, Input, Output, HostListener, EventEmitter, Component, ContentChild, HostBinding, ViewEncapsulation, ChangeDetectionStrategy, ChangeDetectorRef, InjectionToken, Injectable, Injector, NgModule, Inject, ViewChild, ElementRef } from '@angular/core';
import { BreakpointObserver, Breakpoints, LayoutModule } from '@angular/cdk/layout';
import { __extends, __assign } from 'tslib';
import { format, getMonth, getYear, addMonths, addYears, subMonths, subYears, setMonth, setYear, addHours, startOfMonth, getDaysInMonth, addDays, getDate, getDay, isWeekend, parse, compareDesc } from 'date-fns';
...
var DayAdapter = /** @class */ (function (_super) {
    ...
    function DayAdapter(_date) {
        return _super.call(this, parse(_date)) || this;
