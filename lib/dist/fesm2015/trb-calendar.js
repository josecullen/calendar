...
import { format, getMonth, getYear, addMonths, addYears, subMonths, subYears, setMonth, setYear, addHours, startOfMonth, getDaysInMonth, addDays, parse, compareDesc, getDate, getDay, isWeekend } from 'date-fns';
...
class CalendarViewConfig extends CalendarConfig {
     ...
     * @param {?=} stylePrefix
     */
    constructor(header = new CalendarHeaderConfig$1(), month = new MonthViewConfig(), selection = 'simple', stylePrefix = 'trb') {
        super(header, month);
        this.header = header;
        this.month = month;
