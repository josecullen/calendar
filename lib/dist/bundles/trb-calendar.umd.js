(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/cdk/overlay'), require('@angular/cdk/portal'), require('rxjs'), require('@angular/core'), require('@angular/cdk/layout'), require('date-fns')) :
    typeof define === 'function' && define.amd ? define('trb-calendar', ['exports', '@angular/common', '@angular/cdk/overlay', '@angular/cdk/portal', 'rxjs', '@angular/core', '@angular/cdk/layout', 'date-fns'], factory) :
    (factory((global['trb-calendar'] = {}),global.ng.common,global.ng.cdk.overlay,global.ng.cdk.portal,global.rxjs,global.ng.core,global.ng.cdk.layout,global.fns));
}(this, (function (exports,common,overlay,portal,rxjs,core,layout,fns) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var CalendarMonthComponent = /** @class */ (function () {
         ...
         */
            function () {
                return this.breakpointObserver.isMatched(layout.Breakpoints.HandsetPortrait);
            };
        /**
         * @return {?}
         */
            ...
            function () {
                ...
                if (this.context) {
                    ...
                    this.dateStatus = {
                        ...
                        'disabled': this.context.disabled || (this.context.filterDates && this.context.filterDates(fns.parse(this.context.date))),
                    };
                    /** @type {?} */
    ...
    var PickerService = /** @class */ (function () {
        ...
        function PickerService(injector, overlay$$1, breakpointObserver) {
    ...
    var DatepickerComponent = /** @class */ (function () {
        ...
        DatepickerComponent.propDecorators = {
            ...
            onEnter: [{ type: core.HostListener, args: ['input.enter',] }]
        };
     ...
     * @suppress {checkTypes,extraRequire,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DayAdapter = /** @class */ (function (_super) {
        __extends(DayAdapter, _super);
        // private _day: Day
        function DayAdapter(_date) {
            return _super.call(this, fns.parse(_date)) || this;
            // this._day = new Day(parse(_date))
        }
        Object.defineProperty(DayAdapter.prototype, "date", {
            get: /**
             * @return {?}
             */ function () {
                return this.date;
        ...
        Object.defineProperty(DayAdapter.prototype, "dayOfMonth", {
            get: /**
             * @return {?}
             */ function () {
        ...
        Object.defineProperty(DayAdapter.prototype, "dayOfWeek", {
            get: /**
             * @return {?}
             */ function () {
        ...
        Object.defineProperty(DayAdapter.prototype, "name", {
            get: /**
             * @return {?}
             */ function () {
                return this.name;
    ...
    exports.CalendarViewConfig = CalendarViewConfig;
    exports.ICalendarViewConfig = ICalendarViewConfig;
    exports.CalendarHeaderConfig = CalendarHeaderConfig$1;
    exports.MonthViewConfig = MonthViewConfig;
    exports.CalendarSelection = CalendarSelection;
    exports.SelectionType = SelectionType;
    exports.SelectionStatus = SelectionStatus;
    exports.PickSelectionStrategy = PickSelectionStrategy;
    exports.RangeSelectionStrategy = RangeSelectionStrategy;
    exports.SingleSelectionStrategy = SingleSelectionStrategy;
    exports.CellData = CellData;
    exports.DayAdapter = DayAdapter;
    exports.PickerService = PickerService;
    exports.ɵd = CalendarViewConfig;
    exports.ɵh = CalendarHeaderConfig$1;
    exports.ɵi = MonthViewConfig;
    exports.ɵe = CalendarConfig;
    exports.ɵf = CalendarHeaderConfig;
    exports.ɵg = MonthConfig;
    exports.ɵj = Day;
    exports.ɵa = PICKER_DATA;
    exports.ɵb = PickerOverlayRef;
    exports.ɵc = PickerModule;
