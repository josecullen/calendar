import { Component, Input, ContentChild, OnChanges,
  SimpleChanges, Output, EventEmitter, HostBinding,
  ViewEncapsulation, DoCheck, OnInit, TemplateRef } from '@angular/core';
